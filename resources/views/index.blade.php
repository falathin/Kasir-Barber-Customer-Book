  ...
  <div class="grid w-full grid-cols-[repeat(auto-fit,minmax(250px,1fr))] gap-6 gap-y-8">
    ...
    <div class="p-5 bg-green-50 rounded-xl shadow hover:shadow-lg transition">
      <div class="flex items-center justify-between">
        ...
        <div class="bg-white rounded-full p-2 shadow-sm">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" title="Icon Keranjang Belanja">
    ...
    <div class="p-5 bg-blue-50 rounded-xl shadow hover:shadow-lg transition">
      <div class="flex items-center justify-between">
        ...
        <!-- Icon: Cash -->
        <div class="bg-white rounded-full p-2 shadow-sm">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" title="Icon Uang">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 1.343-3 3v2a3 3 0 006 0v-2c0-1.657-1.343-3-3-3zm0 0V6m0 14v-2" />
          </svg>
        </div>
      </div>
      <p class="text-3xl font-bold text-blue-600 mt-2">Rp {{ number_format($totalPendapatan, 0, ',', '.') }}</p>
    </div>
    ...
    <div class="p-5 bg-red-50 rounded-xl shadow hover:shadow-lg transition">
      <div class="flex items-center justify-between">
        ...
        <div class="bg-white rounded-full p-2 shadow-sm">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-red-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" title="Icon Pengembalian">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 14l-5-5m0 0l5-5m-5 5h12a9 9 0 019 9v3" />
          </svg>
        </div>
      </div>
      <p class="text-3xl font-bold text-red-600 mt-2">-Rp {{ number_format(abs($totalPengembalian), 0, ',', '.') }}</p>
    </div>
    ...
    <div class="p-5 bg-purple-50 rounded-xl shadow hover:shadow-lg transition">
      <div class="flex items-center justify-between">
        ...
        <!-- Icon: User -->
        <div class="bg-white rounded-full p-2 shadow-sm">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-purple-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" title="Icon Pengguna">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5.121 17.804A13.937 13.937 0 0112 15c2.5 0 4.847.668 6.879 1.804M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
          </svg>
        </div>
      </div>
    ...
    <div class="p-5 bg-pink-50 rounded-xl shadow hover:shadow-lg transition">
      <div class="flex items-center justify-between">
        ...
        <!-- Icon: Calendar -->
        <div class="bg-white rounded-full p-2 shadow-sm">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-pink-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" title="Icon Kalender">
    ...
    <div class="p-5 bg-yellow-50 rounded-xl shadow hover:shadow-lg transition">
      <div class="flex items-center justify-between">
        ...
        <!-- Icon: Chart Bar -->
        <div class="bg-white rounded-full p-2 shadow-sm">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-yellow-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" title="Icon Grafik Batang">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-6m4 6v-10m4 10v-4M3 21h18" />
          </svg>
        </div>
      </div>
      <p class="text-3xl font-bold text-yellow-600 mt-2">Rp {{ number_format($pendapatanBulanan, 0, ',', '.') }}</p>
    </div>
    ...
    <div class="p-5 bg-indigo-50 rounded-xl shadow hover:shadow-lg transition">
      <div class="flex items-center justify-between">
        ...
        <div class="bg-white rounded-full p-2 shadow-sm">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" title="Icon Kalender Uang">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M12 12v4m2-2h-4m4 0h-4m0 0v4m0-4v-4m-6 8h12a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v7a2 2 0 002 2z" />
          </svg>
        </div>
      </div>
      <p class="text-3xl font-bold text-indigo-600 mt-2">Rp {{ number_format($pendapatanTahunan, 0, ',', '.') }}</p>
    </div>
  </div>
</div>

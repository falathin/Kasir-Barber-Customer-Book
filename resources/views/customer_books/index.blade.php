    ...
    <div class="space-y-6 md:hidden px-4 pb-10">
      @forelse($books as $book)
        @php
          ...
          $statusColor = $isDone ? 'bg-green-100 text-green-700 border-green-500'
                        : ($isProses ? 'bg-blue-100 text-blue-700 border-blue-500'
                        : ($isAntre ? 'bg-yellow-100 text-yellow-700 border-yellow-500'
                        : 'bg-gray-100 text-gray-500 border-gray-400'));
        @endphp

        <div class="relative bg-gradient-to-br from-white via-slate-50 to-gray-100 border border-gray-200 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 overflow-hidden">
          ...
          <div class="p-5 font-mono text-[13px] text-gray-800">
            ...
            <div class="flex justify-between items-center mb-3">
              ...
              <span class="px-2.5 py-1 border rounded-full text-[11px] font-bold uppercase tracking-wide {{ $statusColor }}">
                {{ $status }}
              </span>
            </div>
            ...
            <div class="space-y-1.5 text-[13px]">
              ...
              <div class="flex justify-between">
                <span>Coloring</span>
                <span>{{ $book->colouring_other ?? '-' }}</span>
              </div>
              <div class="flex justify-between">
                <span>Produk</span>

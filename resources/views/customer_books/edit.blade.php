...
@section('title', 'Eksekusi Customer Book')
        ...
        <div class="rounded-2xl overflow-hidden shadow-2xl">
            ...
            <div class="bg-white p-6 sm:p-8 lg:p-10">
                <h2 class="text-2xl sm:text-3xl font-extrabold text-gray-800 mb-2 text-center">
                    Eksekusi Customer Book — #{{ $customerBook->id }}
                </h2>

                <p class="text-sm text-gray-500 text-center mb-6">
                    Lengkapi data pelanggan, pilih layanan, lalu simpan prosesnya.
                </p>
                ...
                <form action="{{ route('customer-books.update', $customerBook->id) }}" method="POST" class="space-y-5" id="customer-book-form">
                    ...
                    <label class="block">
                        ...
                        <select
                            ...
                            class="w-full mt-2 px-4 py-2 border rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-300 transition"
                        >
                            <option value="" disabled {{ old('haircut_type', $customerBook->haircut_type) ? '' : 'selected' }}>-- Pilih Jenis --</option>
                    ...
                    <div class="relative overflow-hidden rounded-2xl p-[1px] bg-gradient-to-br from-indigo-200 via-sky-200 to-purple-200">
                        ...
                        <div class="relative border border-white/60 rounded-2xl p-4 md:p-6 bg-white/80 backdrop-blur-md space-y-5 shadow-lg">
                            <div class="flex items-center justify-between">
                                <div>
                                    <h3 class="text-lg font-semibold text-gray-800">Layanan Barber</h3>
                                    <p class="text-sm text-gray-500">Pilih layanan dan hitung pembayaran</p>
                                </div>
                                ...
                                <div class="w-14 h-14 rounded-xl overflow-hidden border border-white shadow">
                                    <img src="https://static.vecteezy.com/system/resources/previews/044/855/219/original/barbershop-pole-pixel-art-illustration-vector.jpg"
                                        class="w-full h-full object-cover" alt="tiang-barber">
                                </div>
                            </div>
                            ...
                            <div>
                                <div class="grid grid-cols-1 md:grid-cols-[1fr_auto] gap-2">
                                    ...
                                    >
                                        ...
                                        <optgroup label="Pewarnaan dan Styling">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input
                                            ...
                                            class="w-full pl-12 pr-4 py-2 border rounded-xl bg-gray-100 font-semibold"
                                            disabled
                                        >
                                ...
                                <div>
                                    ...
                                    <select name="qr" class="w-full px-4 py-2 border rounded-xl bg-white">
                                        <option value="cash" {{ old('qr', $customerBook->qr) == 'cash' ? 'selected' : '' }}>Tunai</option>
                                        <option value="qr_transfer" {{ old('qr', $customerBook->qr) == 'qr_transfer' ? 'selected' : '' }}>Transfer QR</option>
                                        <option value="no revenue" {{ old('qr', $customerBook->qr) == 'no revenue' ? 'selected' : '' }}>Tanpa Pendapatan</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                                @foreach([
                                    ['Pewarnaan Rambut', 'hair_coloring_price'],
                                    ['Harga Extension Rambut', 'hair_extension_price'],
                                    ['Layanan Extension Rambut', 'hair_extension_services_price']
                                ] as [$label, $id])
                                    <div>
                    ...
                    <input
                        type="hidden"
                        name="colouring_other"
                        id="colouring_other_hidden"
                    ...
                    <label class="block">
                        ...
                        <textarea
                            ...
                            class="w-full mt-2 px-4 py-2 border rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-300 transition"
                            rows="4"
                            placeholder="Keterangan tambahan, catatan, atau permintaan khusus..."
                        >{{ old('rincian', $customerBook->rincian) }}</textarea>
                        @error('rincian')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </label>
                    ...
                    <label class="block">
                        ...
                        @else
                            <input
                                ...
                                class="w-full mt-2 px-4 py-2 border rounded-xl bg-gray-100 cursor-not-allowed"
                                disabled
                            >
